        ...
        <div className="container">
          <div className="section">
            ...
            <div>
              ...
              <p>2010 - 2011 Licenciatura en ctura iversidad noma de uevo Le</p>
              <p>2012 Certificado en odesk ocad 2012  </p>
            ...
            tomar decisiones organi ar tiempo y el manejo de los peque os negocios.</p>
            <p>Diciembre 201 2 - Enero 201 3 | P racticas profesionales Dis e o y adimistraci n
              X K YO aller de rquitectura | lvaro Obreg n 1 Col. Centro Mty
              Mi trabajo como practicante era reali ar croquis detalles y los dibujos
              neces arios para los generadores de obra del proyecto ejecutivo apoyo como
            dibujante en el rea de proyectos.</p>
            <p>Diciembre 201 3 - bril 201 4 | uxiliar dministrativo
              i3 diomas | nillo Perif rico San er nimo
              Se elaboraron documentos de ingres os y egres os de la empres a manejo de
            cuentas facturas organi aci n de calendario de alumnos y maestros etc.</p>
            <p>Enero 201 - ulio 201 | Dibujante Planos para permis os
              SED E | Monterrey
              Reali aci n de croquis y planos de cas a habitaci n para permis os de
              construcci n en los cuales de detallaba informaci n s obre las reas que
            ...
            <p>Manejo de Windows Office OS y paquetes relacionados  </p>
            <p>Manejo de autocad 201  </p>
            <p>Manejo de softwares de modelado 3D </p>
            <p>de proyecto completo en Revit  </p>
            <p>Re c de renders exteriores e interiores  </p>
            <p>Experiencia en modelado de maquetas a escala </p>
          </div>  
